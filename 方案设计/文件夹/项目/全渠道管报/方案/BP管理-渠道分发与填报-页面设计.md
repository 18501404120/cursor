...
年份、区域、国家、**店铺**、**场景/品类**、部门、**Sales**、主体、model、SKU、GTM 标签、状态。
...
| 指定通知人 | 规则为「指定」时必填，单选；**未选指定规则时不展示该字段** |
| 通知说明 | 可选 |
...
| 列 | 说明 |
| --- | --- |
| 勾选、区域、店铺、场景/品类、部门、SKU | 与现网一致；**区域**单元格上行区域、下行国家；**场景/品类**上行场景、下行品类 |
| **Sales** | 多选，SKU 负责人列表 |
...
**通知提报（渠道侧）**：弹窗与 P1 **通知提报** 一致（BP 版本、截止日期、通知范围、通知人规则、指定通知人、通知说明、汇总预览）。指定通知人字段**仅在选择「指定通知人」规则时显示**。确认后更新通知人；若新通知人非当前账号，对应 SKU 从列表移除。
