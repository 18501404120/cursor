...
(function () {
  var ANNOS = [
    ...
    },
    {
      ...
      title: "按钮：新增异常备注",
      html:
        "<p>默认禁用，<strong>批量</strong>前需先在表格勾选至少一行；批量写入备注区间与内容（仅记录与展示）。行内「异常备注」不受此限制。</p>" +
    ...
    },
    {
      ...
      html:
        ...
        "<p>行内<strong>异常备注</strong>始终可点，<strong>不依赖</strong>本行勾选；工具栏<strong>新增异常备注</strong>（批量）仍需先勾选至少一行。</p>" +
