  ...
  var ANNOS = [
    ...
    },
    {
      ...
      html:
        ...
        "<p>目标/人工各 R 柱状图柱顶与轴提示中附带<strong>演示用上下限</strong>（预测值×50% / ×150%，四舍五入），与列表、详情口径一致。</p>",
    },
    {
    ...
    },
    {
      ...
      title: "图表区域",
      html:
        "<p>主图渲染容器（ECharts）；支持图例点击显隐序列、轴提示展示预测值及上下限说明。</p>" +
    ...
    },
    {
      ...
      html:
        ...
        "<p><strong>forecast填写销量</strong>行仅展示业务<strong>最终填报数值</strong>，原型中<strong>不</strong>附加「下限～上限」括号；机器学习/系统规则行仍可带演示区间（见上段）。</p>" +
