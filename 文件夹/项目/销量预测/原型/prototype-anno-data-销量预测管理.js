...
(function () {
  ...
  var ANNOS = [
    ...
    },
    {
      ...
      title: "表格工具栏：预测选择",
      html:
        "<p>下拉选择 R1/R2/R3，常用于驱动表格主预测列高亮、下钻详情默认 Tab 或与图表联动。</p>" +
        "<p>与筛选区「预测选择」用途不同但选项语义一致，需向用户说明避免混淆。</p>",
    },
    {
    ...
    },
    {
      ...
      html:
        ...
        "<p>当前版本在预测数字后追加区间展示：<strong>预测值（下限～上限）</strong>，规则暂定为<strong>下限=预测值×50%</strong>、<strong>上限=预测值×150%</strong>（四舍五入）。</p>" +
