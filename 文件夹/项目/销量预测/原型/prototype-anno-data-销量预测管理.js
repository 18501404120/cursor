  ...
  var ANNOS = [
    ...
    },
    {
      ...
      html:
        ...
        "<p>「详情」打开 dlgBox：<strong>基准销量、弹性系数、影响因子系数、市场预测值、销量目标（BP）、销售目标影响因子（0～1，无 BP 则为空）、预测销量</strong>与上下限/forecast 同表按月展示（无 BP 时上下限仅 M×50%/150%；有 BP 时按 P×50%/150%，预测销量见 M/T/α 规则）。</p>",
    },
    {
