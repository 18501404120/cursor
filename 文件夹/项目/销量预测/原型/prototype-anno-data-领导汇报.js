/**
 * 销量预测项目-领导汇报展示说明.html 专用（静态汇报页逻辑说明）
 */
(function () {
  var ANNOS = [
    {
    ...
    },
    {
      ...
      title: "第三章：总体方案",
      html:
        "<p>从业务闭环、技术栈、因子体系三个层次展开，与《销量预测项目方案》对应。</p>",
    },
    {
      containerSelector: ".diagram-box",
      title: "方案：业务闭环图（SVG）",
      html:
        "<p>节点顺序：销量预测 → 补货建议 → 调拨/履约 → 监控复盘迭代；虚线表示数据回流与模型/规则优化。</p>" +
    ...
    },
    {
      ...
      title: "落地：三模块卡片",
      html:
        "<p><strong>销量预测管理：</strong>筛选-KPI-图-表链路。</p>" +
        "<p><strong>配置中心：</strong>超参数与权限。</p>" +
